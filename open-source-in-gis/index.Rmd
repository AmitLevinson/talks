...
# "Learning GIS with<br>ice-cream parlers"
...
.footenote[ * For the sake of simplicity and to reflect my learning process, I address spatial data here as a vector format (and not, e.g., raster)
] 
...
- Participated in some days of the [#30Daysmapchallenge](https://github.com/tjukanovt/30DayMapChallenge)

--

- Realizing it's time to learn some spatial analysis
...
- It was available in an already used platform (R).
