...
ggplot(isr_map_sf)+
  ...
  theme_void()
```
<img src='img/plots/map.png' height = 350px>
]
]
--
...
<img src='img/plots/squaregrid.png' height = 350px>
]
]
...
```
<img src='img/plots/grid_map.png' height = 350px>
...
Now what? Find the distance for each grid:
...
ggplot(isr_map_sf)+
  ...
  geom_spatial_segment(data = sample_data, mapping = aes(x = us.x, xend = golda.x, y = us.y, yend = golda.y, linetype = relevant, color = relevant), show.legend = FALSE, crs = 4326)+
