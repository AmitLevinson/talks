...
.footnote[*  For the sake of simplicity and to reflect my learning process, I address spatial data here as a vector format (and not, e.g., raster)
] 
...
golda_distances %>% 
  ...
  theme(
    ...
    plot.title = element_text(size = 14, color = "#3f51b5", face= "bold", family = "Avaro"),
