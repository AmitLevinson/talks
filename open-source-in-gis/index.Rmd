...
date: 'June 9, 2021'
description: |
  Outlining my journey learning GIS by mapping distances to ice-cream parlors.
...
meta() %>% 
  ...
  meta_social(
    ...
    image = "https://github.com/AmitLevinson/talks/blob/main/open-source-in-gis/share-card.png?raw=true",
