---
title: "Learning GIS with<br>ice-cream parlors"
author:
  - Amit Levinson
date: 'June 9, 2021'
description: |
...
twitterImage: "https://github.com/AmitLevinson/talks/blob/main/open-source-in-gis/img/share-card.png?raw=true"
...
# Section taken form Garrick Aden‑Buie awesome slides
meta() %>% 
  meta_description(
    paste(
...
`r icons::fontawesome("thumbs-up")` Micha Silver's suggestion to use a raster instead of a vector object
